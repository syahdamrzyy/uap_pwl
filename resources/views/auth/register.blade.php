...
@section('content')
    ...
    <div class="bg-white rounded-2xl shadow-xl p-10 w-full max-w-lg">
        <h2 class="text-2xl font-semibold text-gray-800 mb-1">Selamat Datang</h2>
        <p class="text-gray-400 mb-6 text-sm">Silakan masuk atau daftar untuk melanjutkan</p>
        ...
        <div class="flex border-b mb-6 text-base">
            <a href="{{ route('login') }}" class="w-1/2 text-center py-2 font-medium text-gray-500 hover:text-indigo-500 transition">Masuk</a>
            <span class="w-1/2 text-center py-2 font-medium text-indigo-600 border-b-2 border-indigo-500">Daftar</span>
        </div>
